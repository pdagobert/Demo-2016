...
Geometry createSubdivisedPlane( int width, int height, float size, const VertexLayout& layout, bool centered, std::function< float( int, int ) > heightFunc )
{
	int vWidth = width + 1;
...
Geometry createQuad( const glm::vec2& size, const VertexLayout& layout )
{
	...
	vertices.set( 0, VertexAttribute::Position, glm::vec3( -size.x, -size.y, 0.0f ) );
	vertices.set( 1, VertexAttribute::Position, glm::vec3( size.x, -size.y, 0.0f ) );
	vertices.set( 2, VertexAttribute::Position, glm::vec3( -size.x, size.y, 0.0f ) );
	vertices.set( 3, VertexAttribute::Position, glm::vec3( size.x, size.y, 0.0f ) );
